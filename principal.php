...
<section class="principal-section">
    <div class="principal-container">
        <div class="principal-img">
            <img src="principal.jpg" alt="Principal Image">
        </div>
        <div class="principal-info">
            <h2>Md. Mojammel Haque</h2>
            <p>Principal</p>
            <p>Dinajpur Govt. City College</p>
            <p>Education: BA. in Bangla</p>
            <p>Experience:Teacher as 7+ years.</p>
            <div class="description" style="background: linear-gradient(45deg, #3498db, #2ecc71); color: white; padding: 10px; border-radius: 5px;">
                <p>Very honest person.</p>
            </div>
        </div>
    </div>
</section>
