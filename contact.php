  ...
  <div class="moving-text"><p>দিনাজপুর সরকারি সিটি কলেজের ওয়েবসাইটে আপনাকে স্বাগতম  !</p></div>
    ...
    <div class="contact-info-section">
        <div class="contact-info">
            <p>ঠিকানা: দিনাজপুর সরকারি সিটি কলেজ, দিনাজপুর, বাংলাদেশ</p>
            <p>ইমেইল: info@dinajpurgcc.edu.bd</p>
            <p>ফোন: +8801XXXXXXXXX</p>
        </div>
        <div class="contact-sectors">
            <div class="contact-sector">
                <h3>অফিস সময়</h3>
                <p>সোমবার-শনিবার: 9 AM - 5 PM</p>
            </div>
            <div class="contact-sector">
                <h3>অনুষ্ঠান সময়সূচি</h3>
                <p>সোমবার-শনিবার: 8 AM - 3 PM</p>
            </div>
            <div class="contact-sector">
                <h3>ভর্তি সহায়ক</h3>
