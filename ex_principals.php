...
<div class="leadership-section">
    <center><h2><u>প্রাক্তন অধ্যক্ষবৃন্দ</u></h2></center>
    <div class="leadership-container">

        <div class="leader-box">
            <div class="leader">
                <img src="image/principal1.jpg" alt="Ex-Principal 1">
            </div>
            <div class="leader-info">
                <p class="leader-name">Rifat Ahmed</p>
                <p class="t_desc">2010-2014</p>
            </div>
        </div>

        <div class="leader-box">
            <div class="leader">
                <img src="image/principal2.jpg" alt="Ex-Principal 2">
            </div>
            <div class="leader-info">
                <p class="leader-name">Shyamol Roy</p>
                <p class="t_desc">2014-2020</p>
            </div>
        </div>

        <div class="leader-box">
            <div class="leader">
                <img src="image/principal3.jpg" alt="Ex-Principal 3">
            </div>
            <div class="leader-info">
                <p class="leader-name">Nisan Roy</p>
                <p class="t_desc">2020-2022</p>
            </div>
        </div>
