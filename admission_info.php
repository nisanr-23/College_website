...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="admission_info.css">
...
<div class="pdf-download-section">
    <h2 style="color:white">ভর্তি তথ্য ডাউনলোড</h2>
    <a href="admission/DBMS-Lab-manual.pdf" download>
        <button class="download-button">ডাউনলোড করুন</button>
    </a>
</div>
