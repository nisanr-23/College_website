...
<div class="departments-section">
    <center><h2><u>বিভাগ সমুহ</u></h2></center>
    <div class="departments-container">
        <!-- Science Department -->
        <div class="department-box science">
            <h3>বিজ্ঞান</h3>
            <div class="teacher">
                <!--<img src="science_teacher1.jpg" alt="Teacher 1">-->
                <div class="teacher-info">
                    <p class="teacher-name">শিক্ষকবৃন্দঃ<br>
                    Salam Ahmed <br>
                    Ariful Islam 
                    </p>
                    <p class="student-number">ছাত্র/ছাত্রী সংখ্যা:600</p>
                    <p class="other-info">ল্যাবঃ<br>
                            কম্পিউটার ল্যাব<br>
                            ফিজিক্স ল্যাব<br>
                            কেমিস্ট্রি ল্যাব<br>
                            বায়োলজি ল্যাব<br>    
        ...
        <!-- Arts Department -->
        <div class="department-box arts">
            <h3>আর্টস</h3>
            <div class="teacher">
                <!--<img src="arts_teacher1.jpg" alt="Teacher 1">-->
                <div class="teacher-info">
                    <p class="teacher-name">শিক্ষকবৃন্দঃ<br>
                    Mehedi Hasan <br>
                    Fuad Rahman
        ...
        <!-- Commerce Department -->
        <div class="department-box commerce">
            <h3>বাণিজ্য</h3>
            <div class="teacher">
                <!--<img src="commerce_teacher1.jpg" alt="Teacher 1">-->
                <div class="teacher-info">
                    <p class="teacher-name">শিক্ষকবৃন্দঃ<br>
                    Mojammel Haqule <br>
                    Mahmud Hasan
